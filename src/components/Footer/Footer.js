    ...
    <section id="contact">
      <div class="container">
        ...
        <div class="contact-links">
          <a href="mailto:papallazo.dev@gmail.com" class="contact-link">
            <svg
              class="contact-icon"
          ...
          <a href="tel:+355693259359" class="contact-link">
            <svg
              class="contact-icon"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
          ...
          <a
            href="https://www.linkedin.com/in/kristi-papallazo-4362681a0/"
            class="contact-link"
          >
            <svg
              class="contact-icon"
